...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-slate-50 text-slate-900">
      ...
      <footer className="bg-slate-900 text-slate-600 py-3 text-[9px] font-bold uppercase tracking-widest border-t border-slate-800 px-6 flex justify-between">
        <p>CSV时间序列标注工具 PRO © 2026</p>
